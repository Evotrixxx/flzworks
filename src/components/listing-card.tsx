...
export function ListingCard({
  ...
  return (
    <article className="glass-panel grid overflow-hidden rounded-lg transition hover:-translate-y-0.5 hover:border-cyan-200/80 md:grid-cols-[260px_1fr]">
      <Link href={href} className="relative block aspect-[4/3] bg-white/35 md:aspect-auto">
        <Image
